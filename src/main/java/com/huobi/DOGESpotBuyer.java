 ...
 */
public class DOGESpotBuyer implements Job {
    ...
    Logger logger = LoggerFactory.getLogger(DOGESpotBuyer.class);
    ...
    public static void main(String[] args) {
        DOGESpotBuyer spotBuyer = new DOGESpotBuyer();
        spotBuyer.startUp();

        StrategyCommon.timer("0/5 * * * * ?", DOGESpotBuyer.class, symbol); // 4s 执行一次
    }
